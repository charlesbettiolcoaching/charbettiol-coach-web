"use strict";(()=>{var e={};e.id=8131,e.ids=[8131],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},77397:(e,r,s)=>{s.r(r),s.d(r,{originalPathname:()=>y,patchFetch:()=>f,requestAsyncStorage:()=>_,routeModule:()=>g,serverHooks:()=>w,staticGenerationAsyncStorage:()=>h});var t={};s.r(t),s.d(t,{POST:()=>m,dynamic:()=>l});var o=s(49303),a=s(88716),n=s(60670),i=s(87070),p=s(65655),u=s(21664);let l="force-dynamic",c=new u.ZP({apiKey:process.env.OPENAI_API_KEY}),d={push_pull_legs:{3:["Push","Pull","Legs"],4:["Push","Pull","Legs","Upper"],5:["Push","Pull","Legs","Push","Pull"],6:["Push","Pull","Legs","Push","Pull","Legs"]},upper_lower:{2:["Upper","Lower"],3:["Upper","Lower","Full Body"],4:["Upper","Lower","Upper","Lower"],5:["Upper","Lower","Upper","Lower","Upper"],6:["Upper","Lower","Upper","Lower","Upper","Lower"]},full_body:{2:["Full Body A","Full Body B"],3:["Full Body A","Full Body B","Full Body C"],4:["Full Body A","Full Body B","Full Body C","Full Body D"]},bro_split:{4:["Chest/Triceps","Back/Biceps","Shoulders/Abs","Legs"],5:["Chest","Back","Shoulders","Arms","Legs"],6:["Chest","Back","Shoulders","Arms","Quads/Calves","Hamstrings/Glutes"]}};async function m(e){try{let r=(0,p.e)(),{data:{user:s},error:t}=await r.auth.getUser();if(t||!s)return i.NextResponse.json({error:"Unauthorized"},{status:401});let{client_id:o,title:a,goal:n,experience_level:u,days_per_week:l,session_duration_minutes:m=60,equipment_available:g=[],injuries_limitations:_="",preferred_split:h="auto",notes:w,program_length_weeks:y=4}=await e.json();if(!o||!n||!l)return i.NextResponse.json({error:"Missing required fields"},{status:400});let f=function(e){let r="auto"!==e.preferred_split?`USE THIS SPLIT: ${e.preferred_split.replace(/_/g," ")} — ${d[e.preferred_split]?.[e.days_per_week]?.join(", ")||"assign appropriate focus per day"}`:`Choose the optimal training split for ${e.days_per_week} days/week given the goal.`;return`Design a complete ${e.program_length_weeks}-week training program (output week 1 as the template):
